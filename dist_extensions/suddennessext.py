"""
Generated TouchDesigner Extension for Suddenness
"""
import os
import sys
import numpy as np
...
class SuddennessExt:
    def __init__(self, ownerComp):
        ...
        self.algo = str(self.ownerComp.par.Algo.eval())


        # Initialize PyEyesWeb Feature
        self.analyzer = Suddenness(algo=self.algo)
    ...
    def par_exec_onValueChange(self, par):
        ...
        param_handlers = {
            ...
            'Algo': lambda v: (
                setattr(self, 'algo', str(v)),
                setattr(self.analyzer, 'algo', str(v))
            ),
    ...
    def process_data(self):
        """
        Reads inputs, formats data for Suddenness, and computes the result.
        """
